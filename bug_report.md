...
**Bug:** `parse_input_datetime` stripped the `tzinfo` from aware datetimes without first converting them to UTC. This altered the absolute time for non-UTC offsets (e.g. `10:00:00+06:00` became `10:00:00` naive UTC instead of `04:00:00`).
