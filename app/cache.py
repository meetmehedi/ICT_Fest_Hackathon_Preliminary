...
All mutations are guarded by a single lock to prevent concurrent modification
races (e.g. invalidate iterating keys while another thread inserts a new entry).
"""
import threading
